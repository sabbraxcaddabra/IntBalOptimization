...
# Form implementation generated from reading ui file 'C:\Users\denis\PycharmProjects\BallOptimiz\analysis.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(970, 820)
        Dialog.setMinimumSize(QtCore.QSize(970, 820))
        Dialog.setMaximumSize(QtCore.QSize(970, 820))
    ...
    def retranslateUi(self, Dialog):
        ...
        item.setText(_translate("Dialog", "Pср.бал., МПа"))
        item = self.result_table.horizontalHeaderItem(5)
        item.setText(_translate("Dialog", "Pсн., МПа"))
        item = self.result_table.horizontalHeaderItem(6)
        item.setText(_translate("Dialog", "Pкн., МПа"))
