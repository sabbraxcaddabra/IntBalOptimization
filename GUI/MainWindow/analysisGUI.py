...
# Form implementation generated from reading ui file 'C:\Users\denis\PycharmProjects\VadimAnalyze\TryToMakeTabs.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(970, 825)
        self.raschet_tab = QtWidgets.QTabWidget(Dialog)
        self.raschet_tab.setGeometry(QtCore.QRect(10, 10, 951, 801))
        font = QtGui.QFont()
        ...
        self.result_table.setGeometry(QtCore.QRect(10, 30, 901, 531))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.step_lineEdit.setGeometry(QtCore.QRect(160, 80, 121, 31))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Анализ"))
        self.groupBox.setTitle(_translate("Dialog", "Листинг"))
        ...
        self.groupBox_2.setTitle(_translate("Dialog", "Укажите параметры выполнения расчёта"))
        ...
        self.butt_raschet.setText(_translate("Dialog", "Расчёт"))
        self.groupBox_5.setTitle(_translate("Dialog", "Основные результаты расчёта"))
        self.label_GunSpeed.setText(_translate("Dialog", "Дульная скорость, м/с: "))
        self.label_AverPress.setText(_translate("Dialog", "Максимальное среднебалл. давление, МПа:"))
        self.raschet_tab.setTabText(self.raschet_tab.indexOf(self.calculation), _translate("Dialog", "Расчет"))
        self.groupBox_3.setTitle(_translate("Dialog", "Построение графиков"))
        self.plot_comboBox.setItemText(0, _translate("Dialog", "<не указан>"))
        ...
        self.label_4.setText(_translate("Dialog", "Выберите график для построения:"))
